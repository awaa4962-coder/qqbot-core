...
- 验收：`npm ci` 通过，lint 0 errors / 0 warnings，685/685 测试通过，`release:check` 通过；13/13 离线对话回放通过。Playwright 检查日报进度、编辑、对照、单讨论重写、错误反馈及 390/768/1440 宽度；浏览器交互验收使用模拟模型和发送器，不向真实群发送测试稿。
