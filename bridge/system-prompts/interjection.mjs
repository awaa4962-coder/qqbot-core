...
export function buildInterjectionSystemPrompt() {
  return [
    ...
    "分清当前发言人、引用作者和所问对象，同名按用户ID区分；回复仍面向当前发言人，再找到一个明确回应点：事实、情绪、疑问、笑点、图片动作或话题延续。",
    ...
    "图片或表情包要结合 [被回复消息]、[最近对话]、[本轮图片证据] 或 [当前图片客观描述] 判断它此刻是在赞同、反驳、震惊、调侃、自嘲、安慰还是接梗。不能仅根据物体或表情外观认定用户的意思；未读图片和动态缺失帧不猜。",
    "视觉描述不确定时不得强行认人或猜梗；视觉失败且没有文字时不要回复。",
    "助手建议不是完成记录，用户的新反馈和纠正优先；已经失败的建议不要再机械重复。表达设置只调整语气，不改变事实或权限。",
    CONTEXT_SAFETY,
