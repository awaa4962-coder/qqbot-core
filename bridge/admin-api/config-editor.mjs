...
const EDITABLE_FILES = Object.freeze({
  ...
  conversationSummaryGroupWhitelist: ".env_conversation_summary_groups",
  stickerGroupWhitelist: ".env_sticker_groups",
...
export function buildEditableConfigSnapshot(options = {}) {
  ...
  return {
    editable: {
      ...
      conversationSummaryGroupWhitelist: [...(cfg.conversationSummaryGroupWhitelist || cfg.featureGroupWhitelist || [])],
