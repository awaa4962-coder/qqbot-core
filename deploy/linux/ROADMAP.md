...
本文描述分阶段改造目标，不代表全部功能已经实现或部署。用户已授权按目标持续执行且仅更新 Linux；P0 已完成，P1 能力状态首批已通过候选验证，其余 P1 目标和 P2-P5 尚未完成。实际发布以每批验收记录为准；服务器私有配置、模型路由和 Windows 安装均保持不变。
...
| P1 能力与事实 | 统一能力来源和结果语义，受控自描述，梗库退出活跃链路 | P0 | 进行中：能力状态首批 | 帮助/前端/自述一致，停用不损坏其他模块 |
