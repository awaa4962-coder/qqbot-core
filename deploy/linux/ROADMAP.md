...
本文描述下一轮改造目标，不代表这些功能已经实现或部署。用户已授权按目标持续执行且仅更新 Linux；P0 核验、备份与基线已完成，P1-P5 尚未实现。当前未切换生产代码，服务器配置、模型路由和 Windows 安装均未改变；备份后同版 Linux Bridge 已重新拉起。
...
| P1 能力与事实 | 统一能力来源和结果语义，受控自描述，梗库退出活跃链路 | P0 | 未开始 | 帮助/前端/自述一致，停用不损坏其他模块 |
